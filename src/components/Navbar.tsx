...
import { Calendar, Menu, X, Phone, User, ChevronDown, ExternalLink } from "lucide-react";
      ...
      <div className="container mx-auto flex items-center justify-between h-20 px-4">
        <Link to="/" className="flex items-center gap-3 group relative z-10">
          ...
          <div className="flex flex-col leading-none">
            <span className={`font-heading font-bold text-[14px] tracking-tighter leading-[1] ${scrolled ? "text-foreground" : "text-white"}`}>
              CoWorking
            </span>
            <span className={`font-heading font-bold text-[32px] tracking-tighter leading-[0.8] ${scrolled ? "text-primary" : "text-brand-orange"}`}>
              013
            </span>
          </div>
        </Link>
